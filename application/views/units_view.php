...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <span class="fa fa-list-ul"></span> Units
    ...
    <section class="content">
        <div class="box">
            <div class="box-header" style="">
              <button class="btn btn-primary" id="btn_new"><i class="fa fa-plus-circle" aria-hidden="true"></i> New Unit</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tbl_unit" class="table table-bordered table-striped">
    ...
    <!--modal-->
        <div id="modal_unit" class="modal fade"  tabindex="-1" role="dialog" aria-hidden="true">
...
<?php echo $_rights; ?>
    ...
    $('#tbl_unit tbody').on('click','button[name="edit_info"]',function(){
        _txnMode="edit";
       ...
       // alert($('input[name="tax_exempt"]').length);
        ...
        $('#modal_unit').modal('toggle');

    });

    $('#tbl_unit tbody').on('click','button[name="remove_info"]',function(){
        _selectRowObj=$(this).closest('tr');
        var data=dt.row(_selectRowObj).data();
        _selectedID=data.unit_id;
        delete_notif();
