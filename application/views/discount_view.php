    ...
    <section class="content">
        <div class="box">
            <div class="box-header" style="">
              <button class="btn btn-primary" id="btn_new"><i class="fa fa-plus-circle" aria-hidden="true"></i> New Discount</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tbl_discount" class="table table-bordered table-striped">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header bgm-indigo">
                    ...
                    <h4 class="modal-title">Discount : <transaction class="transaction"></transaction></h4>
                </div>
                <div class="modal-body">
                    <form id="frm_discount">
                    <div class="container-fluid">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="row">
                            <div class="form-group">
                                <label class="col-sm-4" style="margin-top:8px;" for="inputEmail1">Discount Code :</label>
                                <div class="col-sm-8">
                          ...
                          <div class="row" style="margin-top:5px;">
                            <div class="form-group">
                                <label class="col-sm-4" style="margin-top:8px;" for="inputEmail1">Discount Description  :</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-file-text fa-size" aria-hidden="true"></i></span>
                                            <input type="text" name="discount_desc" class="form-control" placeholder="Description" data-error-msg="Description is required." required>
                                    </div>
                                </div>
                            </div>
                          </div>
                          <div class="row" style="margin-top:5px;">
                            <div class="form-group">
                                <label class="col-sm-4" style="margin-top:8px;" for="inputEmail1">Discount Rate :</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-file-text fa-size" aria-hidden="true"></i></span>
                                            <input type="text" name="discount_percent" class="form-control" placeholder="Rate" data-error-msg="Discount Rate is required." required>
                                    </div>
                                </div>
                            </div>
                          </div>
...
<?php echo $_rights; ?>
    ...
    var v = true;
    <?php
        if($this->session->discount_create == 0){
    ?>
            $("#btn_new").remove();
    <?php
        } 
    ?>
    <?php
        if($this->session->discount_update == 0 && $this->session->discount_delete == 0){
    ?>
            v = false;
    <?php
        } 
    ...
    var btn_edit = "";
    var btn_trash = "";
    var _cboDiscount; var _cboBrand; var _cboUnit; var _cboVendor;
        var initializeControls=function(){
        dt=$('#tbl_discount').DataTable({
            ...
            "columns": [
                ...
                { targets:[2],data: "discount_percent" },
                {
                    ...
                    <?php
                        if($this->session->discount_update == 1){
                    ?>      
                    ...
                    <?php
                        ...
                        if($this->session->discount_delete == 1){
                    ?>      
    ...
    $('#btn_create').click(function(){
            if(validateRequiredFields($('#frm_discount'))){
                if(_txnMode==="new"){
                    //alert("aw");
    ...
    $('#tbl_discount tbody').on('click','button[name="edit_info"]',function(){
        _txnMode="edit";
    ...
    $('#tbl_discount tbody').on('click','button[name="remove_info"]',function(){
        _selectRowObj=$(this).closest('tr');
        var data=dt.row(_selectRowObj).data();
        _selectedID=data.discount_id;
        delete_notif();
    ...
    var createCategory=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Discount/transaction/create",
            "data":_data,
    ...
    var updateCategory=function(){
            ...
            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Discount/transaction/update",
                "data":_data,
                "beforeSend": showSpinningProgress($('#btn_save'))
            });
        };
    ...
    var removeDiscount=function(){
            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Discount/transaction/delete",
