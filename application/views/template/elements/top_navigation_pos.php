        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <!-- Menu Body -->
              <!-- Menu Footer-->
              <li class="user-footer" style="background-color:#7f8c8d">
                <!-- <div class="pull-left"> -->
                ...
                <center><a style="color:white;background-color:#e67e22;font-size:15px;border:0px;width:100%;" href="Login/transaction/logout" class="btn btn-default btn-flat">End Batch</a></center>
