    ...
    <center><table width="95%" cellpadding="5" style="font-size: 11">
            <tr>
                <td width="45%" valign="top">
                    ...
                    <address>
                        <strong><?php echo $purchase_order_info->supplier_name; ?></strong><br>
                        <?php echo $purchase_order_info->address; ?><br>
                        <?php echo $purchase_order_info->email_address; ?><br>
                        <abbr title="Phone">P:</abbr> <?php echo $purchase_order_info->landline; ?>
                    </address>
                ...
                <td width="50%" align="right">
                    ...
                    <h4 class="text-navy"><?php echo $purchase_order_info->po_no; ?></h4>
                    ...
                    <p>
                        ...
                        <span><strong>Date : </strong> <?php echo  date_format(new DateTime($purchase_order_info->date_created),"m/d/Y"); ?></span><br />
    ...
    <center>
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-size: 11">
            ...
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($purchase_order_info->total_discount,2); ?></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: right;height: 30px;padding: 6px;"></td>
                <td colspan="2" style="border-bottom: 1px solid gray;text-align: left;height: 30px;padding: 6px;">Total before Tax : </td>
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($purchase_order_info->total_before_tax,2); ?></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: right;height: 30px;padding: 6px;"></td>
                <td colspan="2" style="border-bottom: 1px solid gray;text-align: left;height: 30px;padding: 6px;">Tax Amount : </td>
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($purchase_order_info->total_tax_amount,2); ?></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: right;height: 30px;padding: 6px;"></td>
                <td colspan="2" style="border-bottom:1px solid gray;text-align: left;height: 30px;padding: 6px;"><strong>Total after Tax : </strong></td>
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><strong><?php echo number_format($purchase_order_info->total_after_tax,2); ?></strong></td>
            </tr>
            </tfoot>
        </table><br /><br />
    </center>
