        ...
        <div id="layout-static">
            <div class="page-content"><!-- #page-content -->
                <div class="container-fluid">
                    ...
                    <center>
                        <h3 style = "font-family: tahoma;">Net Profit Report</h3>
                        ...
                        <table width="75%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11px;border: 1px solid gray !important; ">
                            <thead >
                            <tr>
                                <td width="15%" style="text-align: left;height: 15px;padding: 6px;"><b>Barcode</b></td>
                                <td width="25%" style="text-align: left;height: 15px;padding: 6px;"><b>Item Name</b></td>
                                <td width="8%" style="text-align: right;height: 15px;padding: 6px;"><b>SRP</b></td>
                                <td width="7%" style="text-align: right;height: 15px;padding: 6px;"><b>Cost</b></td>
                                <td width="5%" style="text-align: right;height: 15px;padding: 6px;"><b>Qty</b></td>
                                <td width="20%" style="text-align: right;height: 15px;padding: 6px;"><b>Sales Amount</b></td>
                                <td width="20%" style="text-align: right;height: 15px;padding: 6px;border-right: 1px solid gray;"><b>Cost Amount</b></td>
                            </tr>
                            ...
                            <?php
                                ...
                                ?>
                                        <tr style="border: 1px solid gray; ">
                                            <td width="15%" style="text-align: left;height: 15px;padding: 6px;"><?php echo $dt->code; ?></td>
                                            <td width="25%" style="text-align: left;height: 15px;padding: 6px;"><?php echo $dt->descs; ?></td>                                          
                                            <td width="10%" style="text-align: right;height: 15px;padding: 6px;"><?php echo number_format($dt->price,2); ?></td>
                                            <td width="10%" style="text-align: right;height: 15px;padding: 6px;"><?php echo number_format($dt->cost,2); ?></td>
                                            <td width="10%" style="text-align: right;height: 15px;padding: 6px;"><?php echo $dt->qty; ?></td>
                                            <td width="20%" style="text-align: right;height: 15px;padding: 6px;"><?php echo number_format($dt->total,2); ?></td>
                                            <td width="15%" style="text-align: right;height: 15px;padding: 6px;"><?php echo number_format($dt->cost_amount,2); ?></td>
                                        </tr>
                                        <?php
                                        }
                                        ?>
