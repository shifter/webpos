...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <span class="fa fa-credit-card-alt"></span> Charges
    ...
    <section class="content">
        <div class="box">
            <div class="box-header" style="">
              <button class="btn btn-primary" id="btn_new"><i class="fa fa-plus-circle" aria-hidden="true"></i> New Charges</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tbl_charges" class="table table-bordered table-striped">
    ...
    <!--modal-->
        <div id="modal_charges" class="modal fade"  tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="col-md-12">
                              <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-4" style="margin-top:8px;" for="inputEmail1">Charge Code  :</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-tags fa-size" aria-hidden="true"></i></span>
                                                <input type="text" name="charges_code" class="form-control" placeholder="AUTO" data-error-msg="Charge Code is required." readonly>
                                        </div>
                                    </div>
                                </div>
                              </div>
                              <div class="row" style="margin-top:5px;">
                                <div class="form-group">
                                    <label class="col-sm-4" style="margin-top:8px;" for="inputEmail1">Charge Desc  :</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-tags fa-size" aria-hidden="true"></i></span>
                                                <input type="text" name="charges_desc" class="form-control" placeholder="Charge Desc" data-error-msg="Charge description is required." required>
                                        </div>
                                    </div>
                                </div>
                              </div>
...
<?php echo $_rights; ?>
    ...
    var v = true;
    <?php
        if($this->session->charges_create == 0){
    ?>
            $("#btn_new").remove();
    <?php
        } 
    ?>
    <?php
        if($this->session->charges_update == 0 && $this->session->charges_delete == 0){
    ?>
            v = false;
    <?php
        } 
    ...
    var _cboCards; var _cboBrand; var _cboUnit; var _cboVendor;
        ...
        dt=$('#tbl_charges').DataTable({
            ...
            "columns": [
                { targets:[0],data: "charges_code" },
                { targets:[1],data: "charges_desc" },
                {
                    ...
                    <?php
                        if($this->session->charges_update == 1){
                    ?>      
                    ...
                    <?php
                        ...
                        if($this->session->charges_delete == 1){
                    ?>      
    ...
    var updateCard=function(){
            var _data=$('#frm_charges').serializeArray();
            _data.push({name : "charges_id" ,value : _selectedID});
